...
public class Sprite {
	...
	private boolean gravityApplies = false;
	...
	public void update(long elapsedTime) {
		...
		x += dx * elapsedTime;
		y += dy * elapsedTime;
//		System.out.println(elapsedTime + " elapsed sprite");
	...
	public void drawBoundingCircle(Graphics2D g)
	{
		...
		g.drawArc((int)(206 - x),(int)y,img.getWidth(null),img.getHeight(null),0, 360);
	}
	...
	/**
	Set whether the sprite is affected by gravity, or not.
	 */
	public void setGravity(boolean gravityApplies) {
		this.gravityApplies = gravityApplies;
	}
	/**
	Check whether the sprite should be affected by gravity
	 */
	public boolean getGravity() { return gravityApplies;}
